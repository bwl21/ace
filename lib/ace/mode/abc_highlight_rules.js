...
define(function (require, exports, module) {
    ...
    var ABCHighlightRules = function () {
        ...
        this.$rules = {
            start: [
                {
                    token: ['zupfnoter.information.comment.line.percentage', 'information.configstart'],
                    regex: '(%%%%)(zupfnoter\\.config)',
                    comment: 'start the config json',
                    next: "json-start"
                },

                {
                    token: ['zupfnoter.information.comment.line.percentage', 'information.keyword', 'information.keyword.embedded'],
                    regex: '(%%%%)(hn\\.[a-z]*)(.*)',
                ...
                {
                    token: ['information.keyword.embedded', 'information.argument.string.unquoted', 'information.keyword.embedded'],
                    regex: '(\\[[A-Za-z]:)([^\\]]*)(\\])',
